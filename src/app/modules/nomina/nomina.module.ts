...
import { ComprobantesTableComponent } from '@app/components/comprobantes-table/comprobantes-table.component';
...
@Component({
  ...
  imports: [
    ...
    HttpClientModule,
    HeaderComponent, 
    ComprobantesTableComponent, 
    ActionsComponent
  ],
  templateUrl: './nomina.module.html',
  styles: [`
    .nomina-container {
      padding: 20px;
      max-width: 1600px;
...
export class NominaModule implements AfterViewInit {
  ...
  @ViewChild('comprobantesTable') comprobantesTableRef!: ComprobantesTableComponent;
